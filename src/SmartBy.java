...
public class SmartBy {
	...
	@Test
	public void Test_Adding_item_delonghi_ESSPRESO_NESCAFE() {
	...
	public void we_need_to_check_the_correct_price() {
		...
		String the_single_item_price = driver
				.findElement(By.xpath(
						"/html/body/main/div[3]/div[1]/div[2]/div/div/div[1]/div[3]/div[2]/div/div[3]/div/div/span[3]"))
				.getText();
		...
		softassertProcess.assertEquals(ActualWebsite, "Smart Buy | Homepage For Web", "Automation");

		softassertProcess.assertEquals(final_Price * numberOfTry, 199000.0, "Test");
